...
const mysql = undefined;
//const mysql = require('mysql');

let http = require('http').createServer(app);

/* Uncomment to configure socket.io */
...
/* Uncomment to configure persistent sessions system */
...
/* Using middlewares: General middlewares */
...
/* Using middlewares: cross origin resource sharing
	in case the front-end is hosted in a different server than the backend */
app.use(cors());
...
/* Socket.io functions 
	just in case socket.io is configured */
